				...
				<div class="form-group row">
					...
					<div class="col-sm-10">
						<select name="jurusan" class="form-control" required>
							...
							<option value="STAFF" <?php if($data['jurusan'] == 'STAFF'){ echo 'selected'; } ?>>STAFF</option>
							<option value="KEUANGAN" <?php if($data['jurusan'] == 'KEUANGAN'){ echo 'selected'; } ?>>KEUANGAN</option>
							<option value="KEAMANAN" <?php if($data['jurusan'] == 'KEAMANAN'){ echo 'selected'; } ?>>KEAMANAN</option>
							<option value="OPERASIONAL" <?php if($data['jurusan'] == 'OPERASIONAL'){ echo 'selected'; } ?>>OPERASIONAL</option>
						</select>
					</div>
				</div>
				<div class="form-group row">
